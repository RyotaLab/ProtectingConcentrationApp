...
class PurchaseManager: ObservableObject {
    ...
    //productIdの列挙
    let ConsumableProductIds = ["tanabi.ProtectConcentration.donation.item1", "tanabi.ProtectConcentration.donation.item2" , "tanabi.ProtectConcentration.donation.item3"]
    ...
    //private(set) var hasPerchased: Bool = false
